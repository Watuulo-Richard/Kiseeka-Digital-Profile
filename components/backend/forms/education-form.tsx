  ...
  async function handleEducationOnSubmit(
    ...
    try {
      ...
      if (response.ok) {
        setLoading(false);
        toast.success(
          'Education Saved Successfully...✅ The entry has been successfully recorded in the system.',
        );
        ...
        console.log(response);
        toast.error(
          'Failed To Save Work Education...🥺 The entry has failed to be recorded in the system.',
        );
      }
    } catch (error) {
      setLoading(false);
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  {loading ? (
                    ...
                    >
                      ...
                      Saving Education Background, Please Wait...
                    </Button>
                  ) : (
                    <Button
                      type="submit"
